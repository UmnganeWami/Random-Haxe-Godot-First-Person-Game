...
**/
package godot;
@:generated_godot_api @:bindings_api_type("builtin_classes") @:indexing_return_type("float") @:is_keyed(false) @:has_destructor(true) @:avoid_temporaries @:nativeName("PackedFloat64Array") extern class PackedFloat64Array_Fields {
	/**
	...
	**/
	...
	@:is_static(false)
	@:hash(792078629)
	public function append_array(@:default_value(null) array:godot.PackedFloat64Array):Void;
	/**
	...
	**/
	...
	@:is_static(false)
	@:hash(2192974324.)
	public function slice(@:default_value(null) begin:Int, @:default_value("2147483647") ?end:Int):godot.PackedFloat64Array;
	/**
	...
	**/
	...
	@:is_static(false)
	@:hash(949266573)
	public function duplicate():godot.PackedFloat64Array;
	/**
