...
**/
package godot;
@:generated_godot_api @:bindings_api_type("builtin_classes") @:indexing_return_type("String") @:is_keyed(false) @:has_destructor(true) @:avoid_temporaries @:nativeName("GodotString") extern class GodotString_Fields {
	/**
	...
	**/
	...
	@:is_static(true)
	@:hash(2710373411.)
	public function num_scientific(@:default_value(null) number:Float):String;
	/**
	...
	**/
	...
	@:is_static(true)
	@:hash(1555901022)
	public function num(@:default_value(null) number:Float, @:default_value("-1") ?decimals:Int):String;
	/**
	...
	**/
	...
	@:is_static(true)
	@:hash(2111271071)
	public function num_int64(@:default_value(null) number:Int, @:default_value("10") ?base:Int, @:default_value("false") ?capitalize_hex:Bool):String;
	/**
	...
	**/
	...
	@:is_static(true)
	@:hash(2111271071)
	public function num_uint64(@:default_value(null) number:Int, @:default_value("10") ?base:Int, @:default_value("false") ?capitalize_hex:Bool):String;
	/**
	...
	**/
	...
	@:is_static(true)
	@:hash(897497541)
	public function chr(@:default_value(null) char:Int):String;
	/**
	...
	**/
	...
	@:is_static(true)
	@:hash(897497541)
	public function humanize_size(@:default_value(null) size:Int):String;
}