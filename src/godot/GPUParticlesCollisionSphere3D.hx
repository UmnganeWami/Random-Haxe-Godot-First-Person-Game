...
**/
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(true) @:api_type("core") @:is_resource(false) @:is_node(true) extern class GPUParticlesCollisionSphere3D extends godot.GPUParticlesCollision3D {
#if use_properties
	/**
