...
**/
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(true) @:api_type("core") @:is_resource(false) @:is_node(true) extern class CharacterBody3D extends godot.PhysicsBody3D {
#if !use_properties
	/**
	...
	**/
	...
	@:reassignOnSubfieldEdit(set_up_direction_impl, x, y, z)
	public var up_direction(get, set) : godot.Vector3;
#else
	...
	**/
	...
	@:getter("get_up_direction")
	@:setter("set_up_direction")
	public var up_direction : godot.Vector3;
#end
#if use_properties
	/**
	...
	**/
	...
	@:hash(3360562783.)
	@:hash_compatibility(null)
	public function get_up_direction():godot.Vector3;
#if use_properties
	public extern inline function set_up_direction(v: godot.Vector3): godot.Vector3 {
	...
	public function set_up_direction_impl(up_direction:godot.Vector3):Void;
	...
	@:hash(3460891852.)
	@:hash_compatibility(null)
	public function set_up_direction(up_direction:godot.Vector3):Void;
	...
	@:hash(2690739026.)
	@:hash_compatibility(null)
	public function set_motion_mode(mode:godot.CharacterBody3D_MotionMode):Void;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(3529553604.)
	@:hash_compatibility(null)
	public function get_motion_mode():godot.CharacterBody3D_MotionMode;
	@:is_const(false)
	@:is_static(false)
	@:is_vararg(false)
	@:is_virtual(false)
	@:hash(1459986142)
	@:hash_compatibility(null)
	public function set_platform_on_leave(on_leave_apply_velocity:godot.CharacterBody3D_PlatformOnLeave):Void;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(996491171)
	@:hash_compatibility(null)
	public function get_platform_on_leave():godot.CharacterBody3D_PlatformOnLeave;
	/**
	...
	**/
	...
	@:hash(3360562783.)
	@:hash_compatibility(null)
	public function get_floor_normal():godot.Vector3;
	/**
	...
	**/
	...
	@:hash(3360562783.)
	@:hash_compatibility(null)
	public function get_wall_normal():godot.Vector3;
	/**
	...
	**/
	...
	@:hash(3360562783.)
	@:hash_compatibility(null)
	public function get_last_motion():godot.Vector3;
	/**
	...
	**/
	...
	@:hash(3360562783.)
	@:hash_compatibility(null)
	public function get_position_delta():godot.Vector3;
	/**
	...
	**/
	...
	@:hash(3360562783.)
	@:hash_compatibility(null)
	public function get_real_velocity():godot.Vector3;
	/**
	...
	**/
	...
	@:hash(2906300789.)
	@:hash_compatibility(null)
	@:argMeta(0, ":default_value"("Vector3(0, 1, 0)"))
	public function get_floor_angle(@:default_value("Vector3(0, 1, 0)") ?up_direction:godot.Vector3):Float;
	/**
	...
	**/
	...
	@:hash(3360562783.)
	@:hash_compatibility(null)
	public function get_platform_velocity():godot.Vector3;
	/**
	...
	**/
	...
	@:hash(3360562783.)
	@:hash_compatibility(null)
	public function get_platform_angular_velocity():godot.Vector3;
	/**
	...
	**/
	...
	@:hash_compatibility(null)
	@:argMeta(0, ":meta"("int32"))
	public function get_slide_collision(@:meta("int32") slide_idx:Int):godot.KinematicCollision3D;
	/**
	...
	**/
	...
	@:hash(186875014)
	@:hash_compatibility(null)
	public function get_last_slide_collision():godot.KinematicCollision3D;
}