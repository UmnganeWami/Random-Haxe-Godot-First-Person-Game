...
**/
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(true) @:is_instantiable(true) @:api_type("core") @:is_resource(true) @:is_node(false) extern class PhysicsShapeQueryParameters3D extends godot.RefCounted {
#if use_properties
	/**
