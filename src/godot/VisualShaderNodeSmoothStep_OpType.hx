...
**/
package godot;
@:cppEnum @:generated_godot_api @:bindings_api_type("global_enum") #if gdscript @:native("VisualShaderNodeSmoothStep.OpType") #end @:is_bitfield(false) extern enum VisualShaderNodeSmoothStep_OpType {
	/**
