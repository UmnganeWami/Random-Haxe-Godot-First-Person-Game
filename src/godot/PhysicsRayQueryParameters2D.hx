...
**/
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(true) @:is_instantiable(true) @:api_type("core") @:is_resource(true) @:is_node(false) extern class PhysicsRayQueryParameters2D extends godot.RefCounted {
#if use_properties
	/**
	...
	**/
	...
	@:getter("get_from")
	@:setter("set_from")
	@:reassignOnSubfieldEdit(set_from_impl, x, y)
	public var from(get, set) : godot.Vector2;
#else
	...
	**/
	...
	@:getter("get_to")
	@:setter("set_to")
	@:reassignOnSubfieldEdit(set_to_impl, x, y)
	public var to(get, set) : godot.Vector2;
#else
	...
	**/
	...
	@:is_virtual(false)
	@:hash(3196569324.)
	@:hash_compatibility([1118143851])
	@:argMeta(2, ":meta"("uint32"))
	@:argMeta(2, ":default_value"("4294967295"))
	@:argMeta(3, ":default_value"("Array[RID]([])"))
	public static function create(from:godot.Vector2, to:godot.Vector2, @:meta("uint32") @:default_value("4294967295") collision_mask:Int = null, @:default_value("Array[RID]([])") ?exclude:Array<godot.RID>):godot.PhysicsRayQueryParameters2D;
#if use_properties
	public extern inline function set_from(v: godot.Vector2): godot.Vector2 {
	...
	@:native("set_from")
	public function set_from_impl(from:godot.Vector2):Void;
	...
	@:hash(743155724)
	@:hash_compatibility(null)
	public function set_from(from:godot.Vector2):Void;
	...
	@:hash(3341600327.)
	@:hash_compatibility(null)
	public function get_from():godot.Vector2;
#if use_properties
	public extern inline function set_to(v: godot.Vector2): godot.Vector2 {
		set_to_impl(cast v);
		return v;
	}
	...
	@:hash_compatibility(null)
	@:native("set_to")
	public function set_to_impl(to:godot.Vector2):Void;
	...
	@:hash(743155724)
	@:hash_compatibility(null)
	public function set_to(to:godot.Vector2):Void;
	...
	@:hash(3341600327.)
	@:hash_compatibility(null)
	public function get_to():godot.Vector2;
#if use_properties
