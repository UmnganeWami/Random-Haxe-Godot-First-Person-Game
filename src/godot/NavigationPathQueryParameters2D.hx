...
**/
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(true) @:is_instantiable(true) @:api_type("core") @:is_resource(true) @:is_node(false) extern class NavigationPathQueryParameters2D extends godot.RefCounted {
#if use_properties
	/**
	...
	**/
	...
	public function set_start_position_impl(start_position:godot.Vector2):Void;
	...
	@:hash(743155724)
	@:hash_compatibility(null)
	public function set_start_position(start_position:godot.Vector2):Void;
	...
	public function set_target_position_impl(target_position:godot.Vector2):Void;
	...
	@:hash(743155724)
	@:hash_compatibility(null)
	public function set_target_position(target_position:godot.Vector2):Void;
	...
	@:hash(24274129)
	@:hash_compatibility(null)
	public function set_metadata_flags(flags:godot.NavigationPathQueryParameters2D_PathMetadataFlags):Void;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(488152976)
	@:hash_compatibility(null)
	public function get_metadata_flags():godot.NavigationPathQueryParameters2D_PathMetadataFlags;
}