...
**/
package godot;
@:cppEnum @:generated_godot_api @:bindings_api_type("global_enum") #if gdscript @:native("AnimationPlayer.AnimationProcessCallback") #end @:is_bitfield(false) extern enum AnimationPlayer_AnimationProcessCallback {
	/**
