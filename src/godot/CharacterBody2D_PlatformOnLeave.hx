...
**/
package godot;
@:cppEnum @:generated_godot_api @:bindings_api_type("global_enum") #if gdscript @:native("CharacterBody2D.PlatformOnLeave") #end @:is_bitfield(false) extern enum CharacterBody2D_PlatformOnLeave {
	/**
