...
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(false) @:api_type("core") @:is_resource(false) @:is_node(false) extern class NavigationServer3D extends godot.Object {
	...
	**/
	...
	@:is_virtual(false)
	@:hash(1187418690)
	@:hash_compatibility([2121045993])
	@:argMeta(4, ":meta"("uint32"))
	@:argMeta(4, ":default_value"("1"))
	public static function map_get_path(map:godot.RID, origin:godot.Vector3, destination:godot.Vector3, optimize:Bool, @:meta("uint32") @:default_value("1") navigation_layers:Int = 1):godot.PackedVector3Array;
	/**
	...
	**/
	...
	public static function map_get_closest_point_to_segment(map:godot.RID, start:godot.Vector3, end:godot.Vector3, @:default_value("false") use_collision:Bool = false):godot.Vector3;
	/**
	...
	**/
	...
	@:hash(3415008901.)
	@:hash_compatibility(null)
	public static function query_path(parameters:godot.NavigationPathQueryParameters3D, result:godot.NavigationPathQueryResult3D):Void;
	/**
	...
	**/
	...
	@:is_virtual(false)
	@:hash(685862123)
	@:hash_compatibility([3703028813.])
	@:argMeta(3, ":default_value"("Callable()"))
	public static function parse_source_geometry_data(navigation_mesh:godot.NavigationMesh, source_geometry_data:godot.NavigationMeshSourceGeometryData3D, root_node:godot.Node, @:default_value("Callable()") ?callback:godot.Callable):Void;
	/**
	...
	**/
	...
	@:is_virtual(false)
	@:hash(2469318639.)
	@:hash_compatibility([3669016597.])
	@:argMeta(2, ":default_value"("Callable()"))
	public static function bake_from_source_geometry_data(navigation_mesh:godot.NavigationMesh, source_geometry_data:godot.NavigationMeshSourceGeometryData3D, @:default_value("Callable()") ?callback:godot.Callable):Void;
	/**
	...
	**/
	...
	@:hash_compatibility([3669016597.])
	@:argMeta(2, ":default_value"("Callable()"))
	public static function bake_from_source_geometry_data_async(navigation_mesh:godot.NavigationMesh, source_geometry_data:godot.NavigationMeshSourceGeometryData3D, @:default_value("Callable()") ?callback:godot.Callable):Void;
	/**
