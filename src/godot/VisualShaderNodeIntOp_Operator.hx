...
**/
package godot;
@:cppEnum @:generated_godot_api @:bindings_api_type("global_enum") #if gdscript @:native("VisualShaderNodeIntOp.Operator") #end @:is_bitfield(false) extern enum VisualShaderNodeIntOp_Operator {
	/**
