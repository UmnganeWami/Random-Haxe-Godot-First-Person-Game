...
**/
package godot;
@:generated_godot_api @:bindings_api_type("builtin_classes") @:indexing_return_type("int") @:is_keyed(false) @:has_destructor(true) @:avoid_temporaries @:nativeName("PackedInt64Array") extern class PackedInt64Array_Fields {
	/**
	...
	**/
	...
	@:is_static(false)
	@:hash(2090311302)
	public function append_array(@:default_value(null) array:godot.PackedInt64Array):Void;
	/**
	...
	**/
	...
	@:is_static(false)
	@:hash(1726550804)
	public function slice(@:default_value(null) begin:Int, @:default_value("2147483647") ?end:Int):godot.PackedInt64Array;
	/**
	...
	**/
	...
	@:is_static(false)
	@:hash(2376370016.)
	public function duplicate():godot.PackedInt64Array;
	/**
