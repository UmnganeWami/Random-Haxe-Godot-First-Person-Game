...
**/
package godot;
@:cppEnum @:generated_godot_api @:bindings_api_type("global_enum") #if gdscript @:native("NavigationPolygon.SourceGeometryMode") #end @:is_bitfield(false) extern enum NavigationPolygon_SourceGeometryMode {
	/**
