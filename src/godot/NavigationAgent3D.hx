...
**/
@:generated_godot_api @:bindings_api_type("class") @:is_refcounted(false) @:is_instantiable(true) @:api_type("core") @:is_resource(false) @:is_node(true) extern class NavigationAgent3D extends godot.Node {
#if use_properties
	/**
	...
	**/
	...
	@:getter("get_path_height_offset")
	@:setter("set_path_height_offset")
	public var path_height_offset : Float;
#end
#if use_properties
	/**
	...
	**/
	...
	@:getter("get_keep_y_velocity")
	@:setter("set_keep_y_velocity")
	public var keep_y_velocity : Bool;
#end
#if use_properties
	/**
	...
	**/
...
#if use_properties
	public extern inline function set_path_height_offset(v: Float): Float {
		set_path_height_offset_impl(cast v);
		return v;
	}
	...
	@:hash(373806689)
	@:hash_compatibility(null)
	@:native("set_path_height_offset")
	@:argMeta(0, ":meta"("float"))
	public function set_path_height_offset_impl(@:meta("float") path_height_offset:Float):Void;
	...
	@:hash_compatibility(null)
	@:argMeta(0, ":meta"("float"))
	public function set_path_height_offset(@:meta("float") path_height_offset:Float):Void;
	...
	@:hash(1740695150)
	@:hash_compatibility(null)
	public function get_path_height_offset():Float;
#if use_properties
...
#if use_properties
	public extern inline function set_keep_y_velocity(v: Bool): Bool {
		set_keep_y_velocity_impl(cast v);
		return v;
	}
	...
	@:hash(2586408642.)
	@:hash_compatibility(null)
	@:native("set_keep_y_velocity")
	public function set_keep_y_velocity_impl(enabled:Bool):Void;
	...
	@:hash(2586408642.)
	@:hash_compatibility(null)
	public function set_keep_y_velocity(enabled:Bool):Void;
	...
	@:hash(36873697)
	@:hash_compatibility(null)
	public function get_keep_y_velocity():Bool;
#if use_properties
	...
	**/
	...
	@:hash(2713846708.)
	@:hash_compatibility(null)
	public function set_path_metadata_flags(flags:godot.NavigationPathQueryParameters3D_PathMetadataFlags):Void;
	@:return_value_meta(null)
	@:is_const(true)
	@:is_static(false)
	@:is_vararg(false)
	...
	@:hash(1582332802)
	@:hash_compatibility(null)
	public function get_path_metadata_flags():godot.NavigationPathQueryParameters3D_PathMetadataFlags;
	/**
	...
	**/
	...
	public function set_target_position_impl(position:godot.Vector3):Void;
	...
	@:hash(3460891852.)
	@:hash_compatibility(null)
	public function set_target_position(position:godot.Vector3):Void;
	...
	**/
	...
	@:hash(3783033775.)
	@:hash_compatibility(null)
	public function get_next_path_position():godot.Vector3;
	/**
	...
	**/
	...
	@:hash(3460891852.)
	@:hash_compatibility(null)
	public function set_velocity_forced(velocity:godot.Vector3):Void;
#if use_properties
	...
	**/
	...
	@:hash(728825684)
	@:hash_compatibility(null)
	public function get_current_navigation_result():godot.NavigationPathQueryResult3D;
	/**
	...
	**/
	...
	@:hash(497664490)
	@:hash_compatibility(null)
	public function get_current_navigation_path():godot.PackedVector3Array;
	/**
	...
	**/
	...
	@:hash(3783033775.)
	@:hash_compatibility(null)
	public function get_final_position():godot.Vector3;
#if use_properties
