...
**/
package godot;
@:cppEnum @:generated_godot_api @:bindings_api_type("global_enum") #if gdscript @:native("RenderingServer.ParticlesCollisionHeightfieldResolution") #end @:is_bitfield(false) extern enum RenderingServer_ParticlesCollisionHeightfieldResolution {
