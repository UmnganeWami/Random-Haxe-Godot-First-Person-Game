...
**/
package godot;
@:cppEnum @:generated_godot_api @:bindings_api_type("global_enum") #if gdscript @:native("CPUParticles2D.Parameter") #end @:is_bitfield(false) extern enum CPUParticles2D_Parameter {
	/**
